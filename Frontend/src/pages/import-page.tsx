...
const perguntasMockadas: PerguntaRow[] = [
  ...
  },
  {
    id: "q02",
    codigo: "Q02",
    pergunta: "Quantos dispositivos eletrônicos você possui?",
    papel: "Pergunta",
    tipo: "Quantitativa",
    categoria: "Discreta",
  },
  ...
  },
  {
    id: "q04",
    codigo: "Q04",
    pergunta: "Quantas horas por dia você passa em redes sociais?",
    papel: "Pergunta",
    tipo: "Quantitativa",
    categoria: "Contínua",
  },
  ...
  const perguntasFiltradas = useMemo(() => {
    ...
    return perguntas.filter((item) => {
      const correspondeAoTexto =
        termo.length === 0 ||
        normalizarBusca(
          [item.codigo, item.pergunta, item.tipo, item.categoria]
            .filter(Boolean)
            .join(" "),
        ).includes(termo);
