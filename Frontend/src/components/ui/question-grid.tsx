...
export type QuestionGridColumn = "codigo" | "pergunta" | "tipo" | "categoria";
          ...
          {displayedRows.length === 0 ? (
            ...
            displayedRows.map((row, index) => (
              ...
              >
                ...
                <div role="gridcell" className={cellClasses("pergunta")}>
                  <span className="leading-5">{row.pergunta}</span>
                </div>
