export type CategoriaPergunta = "Discreta" | "Contínua" | "Nominal" | "Ordinal";
...
export const perguntasDashboard: PerguntaDashboard[] = [
  ...
  criarPergunta(
    ...
    ],
    {
      ...
      mediana: "R$ 82,00",
      moda: "R$ 0–50",
      primeiroQuartil: "R$ 38,00",
      terceiroQuartil: "R$ 146,00",
    },
    "reais/mês",
    {
      minimo: 0,
  ...
  criarPergunta(
    ...
    [
      ...
      ["Ensino Médio", 335],
      ["Superior incompleto", 220],
      ["Superior completo", 250],
      ["Pós-graduação", 139],
    ],
    { mediana: "Superior incompleto", moda: "Ensino Médio" },
  ),
  criarPergunta(
    "Q13",
    "Você utiliza alguma ferramenta de inteligência artificial?",
    "Nominal",
    [
      ["Sim", 742],
      ["Não", 257],
  ...
  criarPergunta(
    "Q14",
    "Qual ferramenta de IA você mais utiliza?",
    "Nominal",
    [
      ["ChatGPT", 522],
      ["Gemini", 164],
  ...
  criarPergunta(
    ...
    { mediana: "Frequentemente", moda: "Frequentemente" },
  ),
  criarPergunta(
    "Q16",
    "Para qual finalidade você mais utiliza IA?",
    "Nominal",
    [
      ["Trabalho", 235],
      ["Estudo", 418],
  ...
  criarPergunta(
    "Q17",
    "Você confia nas informações geradas por ferramentas de IA?",
    "Ordinal",
    [
      ["Discordo totalmente", 82],
      ["Discordo", 148],
      ["Neutro", 262],
      ["Concordo", 330],
      ["Concordo totalmente", 177],
    ],
    { mediana: "Concordo", moda: "Concordo" },
  ),
  criarPergunta(
    "Q18",
    "Você acredita que a IA substituirá empregos humanos no futuro?",
    "Ordinal",
    [
      ["Discordo totalmente", 59],
      ["Discordo", 118],
      ["Neutro", 205],
      ["Concordo", 369],
      ["Concordo totalmente", 248],
    ],
    { mediana: "Concordo", moda: "Concordo" },
  ),
  criarPergunta(
    "Q19",
    "Você sente que depende da tecnologia para realizar tarefas do dia a dia?",
    "Ordinal",
    [
      ["Discordo totalmente", 54],
      ["Discordo", 120],
      ["Neutro", 268],
      ["Concordo", 352],
      ["Concordo totalmente", 205],
    ],
    { mediana: "Concordo", moda: "Concordo" },
  ),
  criarPergunta(
    "Q20",
    "Você já usou tecnologia para enganar ou prejudicar alguém?",
    "Nominal",
    [
      ["Sim", 96],
      ["Não", 903],
  ...
  criarPergunta(
    "Q21",
    "Você já foi vítima de algum golpe ou fraude digital?",
    "Nominal",
    [
      ["Sim", 238],
      ["Não", 762],
  ...
  criarPergunta(
    "Q22",
    "Você utiliza autenticação de dois fatores nas suas contas?",
    "Nominal",
    [
      ["Sim", 715],
      ["Não", 285],
  ...
  criarPergunta(
    "Q23",
    "Você já compartilhou informações sem verificar se eram verdadeiras?",
    "Nominal",
    [
      ["Sim", 322],
      ["Não", 678],
  ...
  criarPergunta(
    "Q24",
    "Qual sistema operacional de celular você utiliza?",
    "Nominal",
    [
      ["Android", 687],
      ["iOS", 258],
  ...
  criarPergunta(
    "Q25",
    "Você acredita que a tecnologia trouxe mais benefícios do que malefícios?",
    "Ordinal",
    [
      ["Discordo totalmente", 51],
      ["Discordo", 96],
      ["Neutro", 186],
      ["Concordo", 382],
      ["Concordo totalmente", 285],
    ],
    { mediana: "Concordo", moda: "Concordo" },
  ),
];
